<template>
  <main class="site-main dark-bg">
			...
			<section class="page-header">
				<h1 class="text-center text-white text-uppercase fw-700 mb-0">إسأل ألمدرب</h1>
				<div class="bc-container flex align-items-center">
					...
					<ul class="breadcrumb-nav d-flex align-center justify-center mb-0 list-unstyled">
						<li> <router-link to="/" data-text="Home">الرئيسية</router-link></li>						
						<li> <router-link to="/Ask_Trainer" data-text="Home">المقالات الرياضية</router-link></li>
					</ul>
						...
						<div class="col-12 col-lg-8">						
							<div id="comments-container" class="mt-20">
								...
								<div class="comment-author flex">
										...
										<img width="80" src="@/assets/img/comment-author-2.jpg" alt="">
                                        <img class="mt-50" width="80" src="@/assets/img/comment-author-2.jpg" alt="">
								   	 </figure>
									<div class="comment-author-bio mr-20 ">
                                        ...
                                        <div class="qsk pb-2">
                                            <p>عنوان السؤال يوضع هنا</p>
                                            <span class="font-weight-bold">المشي لي من خلال كيفية بدء فصل من البداية إلى نهاية الاحماء؟ </span>
                                        </div>
										<p class="cotha">يجب أن تتعلم أيضا قدر الإمكان عن صاحب العمل المحتمل لديك بحيث يكون لديك "نقاط الحديث" التي سوف تثبت حماسك لمنظمتهم. البحث في مكانة صاحب العمل في مجتمع اللياقة البدنية، والتحدث إلى المهنيين الذين لديهم معرفة مباشرة عن الشركة، ومن ثم تشغيل من خلال ما لا يقل عن ثلاثة إلى أربعة أشواط الممارسة لمقابلتك القادمة. يجب عليك ممارسة كل من أمام المرآة، وإذا كان ذلك ممكنا، أمام صديق الذي وافق على لعب دور "المقابلة الخاص بك. " </p>
								...
								<form id="comments-form" action="#">
									<h5 class="text-uppercase fw-700 text-white mb-50">اضف سؤالك</h5>
									<div class="row">
										<div class="col-12">
											<div class="form-group material-input">
												<textarea id="message" class="form-control input-tp"></textarea>
												<label for="message" class="title-font-1 text-uppercase">Enter your message</label>
											</div>
										</div>
										<div class="col-12 col-md-6">
											<div class="form-group material-input">
												<input type="text" class="form-control input-tp" name="name" id="name">
												<label for="name" class="title-font-1 text-uppercase">Your Name</label>
											</div>
										</div>
										<div class="col-12 col-md-6">
											<div class="form-group material-input">
												<input type="email" class="form-control input-tp" name="name" id="email">
												<label for="email" class="title-font-1 text-uppercase">Email Address</label>
											</div>
										</div>
										<div class="col-12 text-center">
											<button type="submit" class="btn btn-theme">نشر التعليق</button>
										</div>
									</div>
