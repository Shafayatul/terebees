        ...
        <div class="row">
          <div class="col-12 col-lg-8">
                ...
                <figcaption class="transition">
                  ...
                  <ul class="post-meta list-unstyled flex mt-10 mb-0">
                    ...
                    <li class="likes-count">
                      <a href="#"><i class="ti-heart" /> {{ post.comments.data.length }} Likes</a>
                    </li>
                    <li class="comments-count">
                      <a href="#"><i class="ti-comment" /> {{ post.comments.data.length }} Comments</a>
                    </li>
                  </ul>
                </figcaption>
              </figure>
            ...
            <ul class="pagination flex justify-center mb-0">
              ...
              >
                <a href="#"><i class="ti-arrow-right" /></a>
              </li>
              <li
                v-if="(meta.current_page - 3) > 0"
                @click="getData(meta.current_page-3)"
              >
                <a>{{ meta.current_page-3 }}</a>
              </li>
              <li
                v-if="(meta.current_page - 2) > 0"
                @click="getData(meta.current_page-2)"
              >
                <a>{{ meta.current_page-2 }}</a>
              </li>
              <li
                v-if="(meta.current_page - 1) > 0"
                @click="getData(meta.current_page-1)"
              >
                <a>{{ meta.current_page-1 }}</a>
              </li>
              ...
              <li
                v-if="(meta.current_page +2) <= meta.last_page"
                @click="getData(meta.current_page+2)"
              >
                <a>{{ meta.current_page+2 }}</a>
              </li>
              <li
                v-if="(meta.current_page +3) <= meta.last_page"
                @click="getData(meta.current_page+3)"
              >
                <a>{{ meta.current_page+3 }}</a>
              </li>
              <li
                ...
                @click="getData(meta.current_page+1)"
              >
                <a href="#"><i class="ti-arrow-left" /></a>
              </li>
            </ul>
